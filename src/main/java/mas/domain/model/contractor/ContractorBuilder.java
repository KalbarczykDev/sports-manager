...
public class ContractorBuilder {
  ...
  public static ContractorBuilder forContractor(
      Name name,
      Surname surname,
      Address address,
      CompanyName companyName,
    ...
    return new ContractorBuilder(
        name, surname, address, companyName, contactEmail, contactPhoneNumber, nip);
  }
  ...
  public Contractor build() {
    Contractor contractor =
        new Contractor(name, surname, address, companyName, contactEmail, contactPhoneNumber, nip);
